...
function Calendar({
    ...
    return (
        <DayPicker
            ...
            className={cn("p-3 relative w-fit mx-auto", className)}
            classNames={{
                ...
                day_button: cn(
                    buttonVariants({ variant: "ghost" }),
                    "h-9 w-9 p-0 font-normal aria-selected:opacity-100 aria-selected:text-primary-foreground flex items-center justify-center"
                ),
